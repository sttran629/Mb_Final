game.Lvl3 = {
    ...
    update:function(){
        ...
        game.physics.arcade.overlap(this.player,this.door, this.Lvl4_link, null, this);
...
game.state.add('Lvl4_4',Lv4State);
