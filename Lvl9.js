game.Lvl9 = {
    ...
    update:function(){
        ...
        game.physics.arcade.overlap(this.player,this.door, this.Lvl10_link, null, this);
...
var Lv10State = {
    ...
    create:function(){
        game.state.add('Lvl10',game.Lvl10);
        game.state.start('Lvl10');
    },
    update:function(){},
};
...
game.state.add('Lvl10_10',Lv10State);
